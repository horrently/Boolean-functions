...
public class task8 extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Button submitButton = new Button("Построить СДНФ");
        GridPane.setConstraints(submitButton, 1, 1);
        grid.getChildren().add(submitButton);

        Label resultTitleLabel = new Label("СДНФ:");
        ...
        submitButton.setOnAction(event -> {
            ...
            if ((length & (length - 1)) != 0) { // check if length is a power of 2
                ...
                String sdnf = calculateSDNF(functionStr);
                resultLabel.setText(sdnf);
            }
        });
    ...
    //calculateSDNF
    public static String calculateSDNF(String vector){
